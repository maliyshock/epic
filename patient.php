  ...
  try
    ...
    echo "<div class=\"patient margin-c position-rel\">
            ...
            <div class=\"dannye f-left\">
              ...
              <p><span>Номер страховки: </span>". $fields['card_num']."</p>
              <p><span>Секс: </span>".$fields['sex']."</p>
              <p><span>Мейл: </span>".$fields['email']."</p>
              <p><span>Родной город: </span>".$fields['native_city_id']."</p>
              <p><span>История болезни: </span>".$fields['history']."</p>
              <a href=\" index.php \"> ← Вернуться обатно</a>
            </div>
